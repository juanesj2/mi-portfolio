...
export default function Dock({
  ...
  return (
    <motion.div
      style={{ height }}
      className="fixed bottom-0 left-0 right-0 z-50 flex items-end justify-center pointer-events-none mb-2"
    >
      <motion.div
        onMouseMove={({ pageX }) => {
          isHovered.set(1);
        ...
        className={`${className} relative flex items-end w-fit gap-4 rounded-2xl border-neutral-700 border-2 pb-2 px-4 pointer-events-auto bg-[#060010]/80 backdrop-blur-md`}
